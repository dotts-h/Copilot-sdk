...
| [0071](0071-subagent-registry-live-list.md) | Sub-agent registry + live list — status, current activity, live credits beside the chat (S2) | closed | high | 0069 | depends_on: 0070, supersedes 0031's strip, SUBAGENTS_RESEARCH §5, ADR-0041 |
