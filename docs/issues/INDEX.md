...
| [0077](0077-block-ast-seam.md) | Block-AST seam — parse markdown to a typed []Block, render byte-identically (R1) | open | medium | 0076 | depends_on: —, keystone; ADR (new), builds on ADR-0001 |
