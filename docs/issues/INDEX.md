...
| [0052](0052-epic-safe-autopilot-governance.md) | Epic: Hooks & safe autopilot — first-class forge-managed Pre/PostToolUse hooks + safe-by-default governance policy (roadmap v10, G0–G4) | open | high | — | 0053, 0054, 0055, ADR-0029, ADR-0030, ADR-0031, NEXT_FEATURES v10 |
...
| [0055](0055-hooks-ui-mode-binding-timeline-why.md) | Hooks management UI + mode binding + timeline why — in-app CRUD over governance hooks (V27, G4) | open | high | 0052 | ADR-0031 |
