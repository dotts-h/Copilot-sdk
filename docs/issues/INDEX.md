...
| [0031](0031-epic-orchestration-accountability.md) | Epic: orchestration accountability — Runs surface parity (roadmap v6) | open | 0034, 0035 |
...
| [0035](0035-runs-summary-total-cost.md) | Total cost on the per-workflow Runs summary (item V13) | closed | low | 0031 | CONTRACTS §3/§4 |
