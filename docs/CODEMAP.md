...
- L79: `type RunEventLog struct`
- L85: `func RunEventLogPath(dir, runID string) string`
- L93: `func LoadRunEventLog(dir, runID string) (*RunEventLog, error)`
- L117: `func stampRunEvent(e RunEvent) RunEvent`
...
- L109: `func (s *Server) cmdClear() string`
- L127: `func (s *Server) setMode(target, args string) bool`
- L151: `func (s *Server) cmdPlan(args string) string`
- L161: `func (s *Server) cmdAuto(args string) string`
- L170: `func (s *Server) cmdAsk(args string) string`
- L180: `func (s *Server) cmdEffort(arg string) string`
- L202: `func (s *Server) setEffort(effort string)`
- L219: `func (s *Server) cmdModel(name string) string`
- L234: `func (s *Server) setModel(name string)`
- L253: `func (s *Server) cmdAgent(arg string) string`
- L322: `func SeamSpec(cs ctxforge.SessionSpec, defModel, defEffort string, lookupEnv func(string) string, workspace string, autoApprove bool) copilot.SessionSpec`
- L340: `func (s *Server) compiledSpec(agentID string) copilot.SessionSpec`
- L354: `func (s *Server) applyAgentSpec(c copilot.SessionSpec, agentID string, leash telemetry.Leash, leashLabel string) string`
- L375: `func (s *Server) cmdCost() string`
- L396: `func (s *Server) cmdAttach(path string) string`
- L410: `func (s *Server) cmdNav(slug string) string`
- L415: `func isNavSlug(slug string) bool`
- L426: `func commandHelp() string`
...
- L134: `func usageCredits(pb *telemetry.PriceBook, u copilot.UsageData) float64`
- L147: `func eventTypeName(t copilot.EventType) string`
...
- L72: `func (s *Server) abortRun(ctx context.Context)`
- L112: `func (s *Server) launchWorkflow(id string) bool`
...
- L80: `func (l *lane) toolStart(id, name, args string)`
- L94: `func (l *lane) toolProgress(id, msg string)`
- L101: `func (l *lane) toolEnd(id, result string, success bool)`
- L112: `func (l *lane) toolByID(id string) *convo.ToolView`
...
- L24: `func renderLanes(run *workflowRun) string`
- L48: `func laneToolsHTML(tools []*convo.ToolView) template.HTML`
- L59: `func lanePermsHTML(perms []copilot.PermissionRequest) template.HTML`
- L70: `func laneGlyph(st laneStatus) (glyph, state string)`
- L77: `func glyphFor(status string) (glyph, state string)`
...
- L366: `func popOpenTool(open map[int][]int, idx int, name string, labelAt func(pos int) string) (int, bool)`
- L382: `func toolEndGlyph(success bool) (glyph, state string)`
- L392: `func sortLaneIndices(order []int) []int`
- L400: `func laneLess(a, b int) bool`
- L415: `func clockTime(t time.Time) string`
...
### workflow_crud.go (254 LOC)
- L18: `func (s *Server) workflowsPartial() string`
- L74: `func renderWorkflowForm(w ctxforge.Workflow, isNew bool, errMsg string) string`
- L95: `func stepsToText(steps []ctxforge.WorkflowStep) string`
- L115: `func stepsFromText(raw string) []ctxforge.WorkflowStep`
- L144: `func splitStepLine(line string) (head, prompt string)`
- L163: `func formatStepCondition(c *ctxforge.StepCondition) string`
- L181: `func parseStepCondition(spec string) *ctxforge.StepCondition`
- L201: `func workflowFromForm(r *http.Request, id string) ctxforge.Workflow`
- L211: `func (s *Server) handleWorkflowNew(w http.ResponseWriter, r *http.Request)`
- L215: `func (s *Server) handleWorkflowEdit(w http.ResponseWriter, r *http.Request)`
- L230: `func (s *Server) handleWorkflowCreate(w http.ResponseWriter, r *http.Request)`
- L239: `func (s *Server) handleWorkflowUpdate(w http.ResponseWriter, r *http.Request)`
- L249: `func (s *Server) handleWorkflowDelete(w http.ResponseWriter, r *http.Request)`
