...
| [0008](0008-session-recipes-fix-quality-and-architecture-pass.md) | Recipe update + the `make doctor` resolution fix (the multi-session pain → REGRESSIONS #23); exhausted-roadmap handling (no v17 fabrication); quality pass (PR #173) + architecture assessment (ADR-0056); `git switch main` tag-trap correction | 2026-06-13 |
